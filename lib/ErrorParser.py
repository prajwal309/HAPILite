    ...
    while RowIndex<len(ErrorArray):
        ...
        while(Position<6):
            ...
            if Position==0:
                #Case of line center
                if Item==0:
                    Values[RowIndex,Position] = 50.0
                elif Item==1:
                    Values[RowIndex,Position] = 5.0
                elif Item==2:
                    Values[RowIndex,Position] = 5.0e-1
                elif Item==3:
                    Values[RowIndex,Position] = 5.e-2
                elif Item==4:
                ...
                if Item==0:
                    ...
                    Values[RowIndex,Position] = 0.15
                elif Item==5:
                    Values[RowIndex,Position] = 0.075
                elif Item==6:
                    Values[RowIndex,Position] = 0.035
                elif Item==7:
                    Values[RowIndex,Position] = 0.015
                elif Item==8:
                    Values[RowIndex,Position] = 0.005
            Position+=1
        RowIndex+=1
    return Values
